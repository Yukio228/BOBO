...
def get_password(message):
    ...
    try:
        ...
        if user_type == 'admin' or user_type == 'advisor':
            ...
            query = """
                SELECT student_id, lname, fname, mname, citizenship, nationality, date_of_birth, 
                    gender, phone_number, IIN, year_of_college 
                FROM student
            ...
            columns = [
                'Student ID', 'Last Name', 'First Name', 'Middle Name', 'Citizenship',
                'Nationality', 'Date of Birth', 'Gender', 'Phone Number', 'IIN', 'Year of College'
            ]
            ...
            if not profile_complete:
                ...
                cursor.execute("""
                    SELECT lname, fname, mname, citizenship, nationality, date_of_birth, 
                           gender, phone_number, IIN, year_of_college 
